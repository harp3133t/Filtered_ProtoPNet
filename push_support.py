...
def push_prototypes(dataloader, # pytorch dataloader (must be unnormalized in [0,1])
    ...
    prototype_network_parallel.module.prototype_vectors_support.data.copy_(torch.tensor(prototype_update, dtype=torch.float32).cuda())
...
def update_prototypes_on_batch(search_batch_input,
    ...
    with torch.no_grad():
        ...
        protoL_input_torch, proto_dist_torch = prototype_network_parallel.module.push_forward_support(search_batch)
